...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/bootstrap-3.3.6-dist/css/bootstrap.css" />
<style type="text/css">  
        .code   
        {   
...
<body onload="createCode()">
	<div class="row-fluid" style="margin-top: 200px;">
		...
		<div class="col-md-4">
			<form role="form" class="form-horizontal" action="user-check"
	...
	<script src="${pageContext.request.contextPath}/static/bootstrap-3.3.6-dist/js/bootstrap.js" type="text/javascript"></script>

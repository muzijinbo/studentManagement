...
<html xmlns="http://www.w3.org/1999/xhtml">
	        ...
	        $(function () {
	         ...
	         function loadData(pars) {
	            $('#banji').datagrid({	                
	                ...
	                columns: [[
	                    { field: 'b_id', title: '班级编号', align: 'center' ,checkbox:true },                   
	                    { field: 'b_name', title: '班级名称', align: 'center', width: 100 },                                   	               		
	                    {
	                          field: 'operation', title: '操作', align: 'center', width: 100,
	                          formatter: function (value, row, index) {
	                              var str = "";
	                              str += '<a href="banji-delete?ID=' + row.b_id + ' class="easyui-linkbutton c1" style="width:70px">删除</a>';                              
	                             //str += '<a href="banji-delete?ID=" class="easyui-linkbutton c1" style="width:50px">删除</a>';                              
	                ...
	                toolbar: [{
	            		...
	            		iconCls: 'icon-remove',
	            		handler:function(){
							var arr =$('#banji').datagrid('getSelections');
							if(arr.length <=0){
								$.messager.show({
									title:'提示信息!',
									msg:'至少选择一行记录进行删除!'
								...
								$.messager.confirm('提示信息' , '确认删除?' , function(r){
										if(r){
												...
												$.post('banji-delete' , {ids:ids} , function(result){
													//1 刷新数据表格 
													$('#banji').datagrid('reload');
													//2 清空idField   
													$('#banji').datagrid('unselectAll');
													//3 给提示信息 
													$.messager.show({
														title:'提示信息!' , 
														msg:'操作成功!'
	...
	<body>
	    ...
	    <div id="mydialog" title="新增用户" modal=true  draggable=false class="easyui-dialog" closed=true style="width:300px;">
	    		<form id="myform" action="banji-save" method="post">   				
	    				<table>    					
	    					<tr>
	    						<td>班级名称:</td>
	    						<td>

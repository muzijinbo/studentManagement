...
<html xmlns="http://www.w3.org/1999/xhtml">
	        ...
	        $(function () {
	         ...
	         function loadData(pars) {
	            $('#course').datagrid({	                
	                ...
	                columns: [[
	                    { field: 'c_id', title: '课程编号', align: 'center' ,checkbox:true },
	                   
	                    { field: 'c_name', title: '课程名称', align: 'center', width: 100 },                                   
	                    { field: 'type', title: '课程类型', align: 'center', width: 100 },                                   
	                    { field: 'credit', title: '课程类型', align: 'center', width: 100 },                                   			               	
	                    {
	                          field: 'operation', title: '操作', align: 'center', width: 100,
	                          formatter: function (value, row, index) {
	                              var str = "";
	                              str += '<a href="course-delete?ID=' + row.b_id + ' class="easyui-linkbutton c1" style="width:70px">删除</a>';                              
	                             //str += '<a href="course-delete?ID=" class="easyui-linkbutton c1" style="width:50px">删除</a>';                              
	                ...
	                toolbar: [{
	            		...
	            		iconCls: 'icon-remove',
	            		handler:function(){
							var arr =$('#course').datagrid('getSelections');
							if(arr.length <=0){
								$.messager.show({
									title:'提示信息!',
									msg:'至少选择一行记录进行删除!'
								...
								$.messager.confirm('提示信息' , '确认删除?' , function(r){
										if(r){
												...
												$.post('course-delete' , {ids:ids} , function(result){
													//1 刷新数据表格 
													$('#course').datagrid('reload');
													//2 清空idField   
	...
	<body>
	    ...
	    <div id="mydialog" title="新增用户" modal=true  draggable=false class="easyui-dialog" closed=true style="width:300px;">
	    		<form id="myform" action="course-save" method="post">   				
	    				<table>    					
	    					<tr>
	    						<td>课程名称:</td>
	    						<td>
	    							<input type="text" name="b_name" class="easyui-validatebox" required=true validType="equalLength[4]" missingMessage="课程名称必填!" value="" />
